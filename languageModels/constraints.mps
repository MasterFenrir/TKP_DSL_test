...
<model ref="r:6126b54b-5e46-4a50-99e3-bf3d70d902df(jetbrains.mps.samples.Expressions_clone.constraints)">
  ...
  <node concept="1M2fIO" id="1N6$leSa9kX">
    <ref role="1M2myG" to="qheb:1N6$leSa9in" resolve="ArithmeticSimpleMathExpression" />
    <node concept="EnEH3" id="1N6$leSa9lL" role="1MhHOB">
      <ref role="EomxK" to="qheb:1N6$leSa9jE" resolve="operator" />
