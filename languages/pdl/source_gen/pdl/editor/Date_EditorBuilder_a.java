...
/*package*/ class Date_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_dwy1sf_a() {
    ...
    editorCell.addEditorCell(createConstant_dwy1sf_a0());
    editorCell.addEditorCell(createProperty_dwy1sf_b0());
    editorCell.addEditorCell(createConstant_dwy1sf_c0());
    editorCell.addEditorCell(createProperty_dwy1sf_d0());
    editorCell.addEditorCell(createConstant_dwy1sf_e0());
    editorCell.addEditorCell(createProperty_dwy1sf_f0());
    editorCell.addEditorCell(createConstant_dwy1sf_g0());
    return editorCell;
  }
  private EditorCell createConstant_dwy1sf_a0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "[");
    editorCell.setCellId("Constant_dwy1sf_a0");
  ...
  private EditorCell createProperty_dwy1sf_d0() {
    CellProviderWithRole provider = new PropertyCellProvider(myNode, getEditorContext());
  ...
  private EditorCell createConstant_dwy1sf_e0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_dwy1sf_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_dwy1sf_f0() {
    CellProviderWithRole provider = new PropertyCellProvider(myNode, getEditorContext());
  ...
  private EditorCell createConstant_dwy1sf_g0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "]");
    editorCell.setCellId("Constant_dwy1sf_g0");
    Style style = new StyleImpl();
    new CommandStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
